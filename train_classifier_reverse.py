...
if __name__ == '__main__':
    ...
    subset_idx = get_subset_indices(mimic_train, args.n_samples,
    ...
    model, results = train(args, model, criterion, optimizer, lr_scheduler,
                           dataloaders, device)
    ...
    torch.save(model.state_dict(),
               os.path.join(exp_dir, f'checkpoint_{args.iter_idx}.pt'))
